...
const SlideTabs = () => {
  ...
  return (
    ...
    >
      ...
      <Tab setPosition={setPosition} to="/vehicle_dashboard">
        Vehicle Details
      </Tab>
      <Tab setPosition={setPosition} to="/driver_dashboard">
        Driver Details
      </Tab>
      <Tab setPosition={setPosition} to="/service_record">
        Service Records
      </Tab>
      <Tab setPosition={setPosition} to="/clients">
        Clients
      </Tab>
      <Tab setPosition={setPosition} to="/billing_system">
        Bills
      </Tab>
...
const Tab = ({ children, setPosition, to }) => {
  ...
  return (
    <li
      ...
      className={`relative z-10 block cursor-pointer px-3 py-1.5 uppercase text-white mix-blend-difference md:px-5 md:py-4 md:text-base ${
        isActive ? "font-extrabold underline underline-offset-[7px]" : "text-xs"
      }`}
    >
